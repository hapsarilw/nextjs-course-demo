...
function MeetupItem(props) {
  const router = Object(router_["useRouter"])(); // Navigate programatically
...
async function getStaticProps() {
  ...
  // fetch data from an API
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://amihapsari:Amihapsari123@cluster0.wq6iu.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
